            ...
            <footer>
                <div className="container">
                    ...
                    <div className="row copyright d-flex pt-3 mt-3">
                        ...
                        <p className="col-12"><Link target="_blank" to="mailto:ziadelsayed2004@gmail.com">Copyright 2025 © Ziad Elsayed<br/>All Right Reserved <span>-</span> Powered By Ziad Elsayed<br/>E-Commerce App Full Stack Using &#123; Node & Express & React &#125;</Link></p>
                    </div>
                </div>
            </footer>
        </>
